...
export default function Home() {
  ...
  function handleBuyTicket() {
    if (!custodyAddress) {
      alert(
        "To buy a ticket, your custody wallet address should be provided by the Frame, or enter it manually (this feature is under development).",
      )
      return
    }
    setHasTicket(true)
      ...
      {isAuthenticated && user && (
        <>
          ...
          {!gameStarted && (
            ...
            >
              <label htmlFor="custodyAddr" style={{ display: "block", marginBottom: "5px" }}>
                Custody Wallet Address (optional):
              </label>
              <input
                id="custodyAddr"
                type="text"
